...
d3.csv('strava/data/recent_activities.csv', function(data){
   ...
   var parentWidth = parent.node().getBoundingClientRect().width * 0.95
   var parentHeight = parent.node().getBoundingClientRect().height * 0.95
   var color = '#90FFC4';
   
   var radius = (Math.min(parentWidth, parentHeight)) / 2;
