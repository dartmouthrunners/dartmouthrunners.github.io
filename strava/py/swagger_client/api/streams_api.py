...
class StreamsApi(object):
    ...
    def get_activity_streams(self, id, keys, key_by_type, **kwargs):  # noqa: E501
        ...
        Returns the set of streams for an activity  # noqa: E501
        ...
        :param bool key_by_type: Requests the server to key stream objects by type in the response – must be set to true (required)
        :return: StreamSet
    ...
    def get_segment_streams(self, id, keys, key_by_type, **kwargs):  # noqa: E501
        ...
        Returns the set of streams for a segment  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
