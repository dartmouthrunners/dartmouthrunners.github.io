...
class SegmentsApi(object):
    ...
    def explore_segments(self, bounds, **kwargs):  # noqa: E501
        ...
        :param str activity_type: The activity of the segments
        :param int min_cat: The minimum category of the segment's (for climbs)
        :param int max_cat: The maximum category of the segment's (for climbs)
    ...
    def get_leaderboard_by_segment_id(self, id, **kwargs):  # noqa: E501
        ...
        Returns the leaderboard of a segment.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        ...
        :param async bool
        :param int id: The identifier of the segment to get the leaderboards for. (required)
        :param str gender: Enables filtering of entries by a given gender
        :param str age_group: Enables filtering of entries by a given age-group
        :param str weight_class: Enables filtering of entries by a given weight class
        :param bool following: Enables filtering of entries by the friends of the logged-in athlete
        :param int club_id: Enables filtering of entries by the membership of a given clu
        :param str date_range: Enables filtering of entries by a given date range
    ...
    def get_logged_in_athlete_starred_segments(self, **kwargs):  # noqa: E501
        ...
        Returns a list of the segments starred by logged-in athlete.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
    ...
    def get_segment_by_id(self, id, **kwargs):  # noqa: E501
        ...
        Returns the segment identified by the given identifier.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
    ...
    def star_segment(self, id, **kwargs):  # noqa: E501
        ...
        Stars a segment referenced by its identifier.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
